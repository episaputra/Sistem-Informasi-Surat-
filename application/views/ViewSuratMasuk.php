                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                                <div class="col-sm-12">
                                    <div class="card-box">
                                        <h4 class="page-title"><b>Surat Masuk</b></h4>
...
?>                                    <!--End Notifikasi-->
                            ...
                            <div style="padding-left: 910px" id="datatable-editable_filter" class="dataTables_filter"><label>Search:
                                <form action="<?= base_url()?>index.php/SuratMasukController/search" method="POST">
                        ...
                        <table id="demo-foo-pagination" class="table m-b-0 toggle-arrow-tiny" data-page-size="40">
                                        <thead>
                                            <tr role="row">
                                                <th tabindex="0" aria-controls="datatable-editable" rowspan="1" colspan="1"  style="width: 90px;">Id Surat</th>
                                                <th tabindex="0" rowspan="1" colspan="1"  style="width: 190px;">No. Surat</th>
                                                <th tabindex="0" aria-controls="datatable-editable" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 290px;">Perihal</th>
                                                <th rowspan="1" colspan="1" aria-label="Actions" style="width: 160px; ">Asal Surat</th>
                                                <th rowspan="1" colspan="1" aria-label="Actions" style="width: 135px;">Tanggal Surat</th>
...
?>  
            ...
            <!-- ============================================================== -->
 <?php echo form_open_multipart('index.php/SuratMasukController/prosesTambahSurat'); ?>
                                            ...
                                            <div class="modal-content"> 
                                                ...
                                                <div class="modal-body"> 
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                ...
                                                                <input required type="text" class="form-control field-3" name="nosurat" placeholder="No. Surat"> 
                                                            </div> 
                                                        </div> 
                                                    </div> 
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                ...
                                                                <input required type="text" class="form-control field-3" name="perihalsurat" placeholder="perihal"> 
                                                            </div> 
                                                        </div> 
                                                    </div>
                                                     <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                ...
                                                                <input type="text" required class="form-control field-3" name="asalsurat"  placeholder="Asal Surat"> 
                                                            </div> 
                                                        </div> 
                                                    </div> 
                                                    <div class="row"> 
                                                    ...
                                                    <div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <label for="field-3" class="control-label">Tanggal Diterima</label> 
                                                                <input type="date" name="tglterima" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div> <br>
                                                    <div class="row"> 
                                                    ...
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                <label for="field-3" class="control-label">Disposisi Surat</label> 
                                                                <input required type="text" class="form-control field-3" name="disposisi" placeholder="Disposisi Surat"> 
                                                            </div> 
                                                        </div> 
                                                    </div>
                                                    <div class="row"> 
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input required type="file" accept="application/pdf" name="berkassurat" class="form-control">
                                                        </div>
                                                    </div>  
                                                </div> 
                                                ...
                                                <div class="modal-body"> 
                                                    ...
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                <label for="field-3" class="control-label">Perihal </label> 
                                                                <input type="text" value="<?=$data->perihal?>" class="form-control field-3" name="perihalsurat" placeholder=""> 
                                                            </div> 
                                                        </div> 
                                                    </div>
                                                     <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                <label for="field-3" class="control-label">Asal Surat</label> 
                                                                <input type="text" class="form-control field-3" name="asalsurat" value="<?=$data->asal?>" placeholder="Asal Surat"> 
                                                            </div> 
                                                        </div> 
                                                    </div> 
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                <label for="field-3" class="control-label">Jenis Surat</label> 
                                                                <input type="text"  class="form-control field-3" name="jenissurat"  value="<?=$data->jenis_surat?>"placeholder="Jenis Surat"> 
                                                            </div> 
                                                        </div> 
                                                    </div>
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                <label for="field-3" class="control-label">Sifat Surat</label> 
                                                                 <select  name="sifatsurat" value ="<?= $data->sifat_surat?>" class="form-control">
                                                    ...
                                                    <div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <label for="field-3" class="control-label">Tanggal Surat</label> 
                                                                <input type="date"  name="tglsurat" value="<?=$data->tanggal?>" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <label for="field-3" class="control-label">Tanggal Diterima</label> 
                                                                <input type="date"  name="tglterima" value="<?=$data->tanggalDiterima?>" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div> <br>
                                                    <div class="row"> 
                                                    ...
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                <label for="field-3" class="control-label">Disposisi Surat</label> 
                                                                <input required type="text"  class="form-control field-3" value="<?=$data->disposisi?>" name="disposisi" placeholder="Disposisi Surat"> 
                                                            </div> 
                                                        </div> 
                                                    </div>
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group">
                                                            <label for="field-3" class="control-label">Lampiran</label>  
                                                                <input required type="text"  class="form-control field-3" value="<?=$data->lampiran?>" name="lampiran" placeholder="Lampiran"> 
                                                            </div> 
                                                        </div> 
                                                    </div>
                                        ...
                                        <div class="modal-dialog"> 
                                            <div class="modal-content"> 
                                                ...
                                                <div class="modal-body"> 
                                                    ...
                                                    <tr>
                                                        <td><b>Tanggal Diterima</b></td><td>:</td>
                                                        <td > <?php echo date('d-m-Y',strtotime($data->tanggalDiterima)); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td><b>Disposisi</b></td> <td>:</td>
...
var pesan = confirm("Apakah anda yakin ingin menghapus Surat ID "+id+" ?");
        if(pesan){
            window.location.href ="<?= base_url()?>index.php/SuratMasukController/prosesHapusSurat/"+id;
        }
    }
</script>
