                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="<?= base_url() ?>index.php/LoginCon/logout" class="waves-effect"><i class="ti-light-bulb"></i></span><span> Log Out </span> </a>
                            </li>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6"><div class="dataTables_length"><label>Show <select  aria-controls="datatable-editable" class="form-control input-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div>
                                    </div>
                                        <div class="col-sm-6">
                                            <div id="datatable-editable_filter" class="dataTables_filter"><label>Search:
                                <form action="<?= base_url()?>index.php/SuratMasuk/search" method="POST">
                                    <label><input type="text"  name="keyword" class="form-control input-sm" placeholder="" aria-controls="datatable-editable"></label>
                                    <select name="jenisKeyword" aria-controls="datatable-editable" class="form-control input-sm"><option value="id">ID</option><option value="no_surat">Nomor Surat</option><option value="judul">Judul Surat</option><option value="asal">Asal</option></select>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12"><table class="table table-striped dataTable no-footer" id="datatable-editable" role="grid" aria-describedby="datatable-editable_info">
                                        <thead>
                                            <tr role="row">
...
?>  
    ...
    <?php echo form_open_multipart('index.php/SuratMasuk/prosesTambahSurat'); ?>
                                                ...
                                                <div class="modal-body"> 
                                                    ...
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                <label for="field-3" class="control-label">Judul Surat</label> 
                                                                <input type="text" class="form-control field-3" name="judulsurat" value="<?=$data->judul?>" placeholder=""> 
                                                            </div> 
                                                        </div> 
                                                    </div>
                                                     <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                <label for="field-3" class="control-label">Asal Surat</label> 
                                                                <input type="text" class="form-control field-3" value="<?=$data->no_surat?>" name="asalsurat"  placeholder=""> 
                                                            </div> 
                                                        </div> 
                                                    </div> 
...
var pesan = confirm("Apakah anda yakin ingin menghapus Surat ID "+id+" ?");
        if(pesan){
            window.location.href ="<?= base_url()?>index.php/SuratMasuk/prosesHapusSurat/"+id;
        }
    }
</script>
